...
const ProductManager = (props) => {
    ...
    uploadTask.on('state_changed', (snapshot) => {
      ...
      storage.ref('products').child(filename).getDownloadURL()
        .then(fireBaseUrl => {
          ...
          Axios
            .post('http://52.8.24.75:3000/api/products', request)
            .then(response => {
              getProducts();
              setImageAsFile('');
              setLoading(false);
  ...
  const editProductHandler = (e) => {
    ...
    Axios
      .put(`http://52.8.24.75:3000/api/products/${_id}`, request)
      .then(response => {
        getProducts();
      })
      .catch(err => console.error(err));
  ...
  const deleteHandler = (e) => {
    ...
    Axios
      .delete(`http://52.8.24.75:3000/api/products/${_id}`)
      .then(response => {
  ...
  const addFeature = (e) => {
    ...
    Axios
      .put(`http://52.8.24.75:3000/api/products/${_id}`, { features })
      .then(response => {
        getProducts();
        setShowFeatures(_id);
      })
  ...
  const addSpec = (e) => {
    ...
    Axios
      .put(`http://52.8.24.75:3000/api/products/${_id}`, { specs })
      .then(response => {
        getProducts();
        setShowSpecs(_id);
      })
    ...
    uploadTask.on('state_changed', (snapshot) => {
      ...
      storage.ref('products').child(filename).getDownloadURL()
        .then(fireBaseUrl => {
          ...
          Axios
            .put(`http://52.8.24.75:3000/api/products/${_id}`, { images })
            .then(response => {
    ...
    uploadTask.on('state_changed', (snapshot) => {
      ...
      storage.ref('products').child(filename).getDownloadURL()
        .then(fireBaseUrl => {
          ...
          Axios
            .put(`http://52.8.24.75:3000/api/products/${_id}`, { downloads })
            .then(response => {
              getProducts();
